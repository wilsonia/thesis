...
\begin{tikzpicture}[shorten >=1pt,auto, thick,
    ...
    \node[wf] (w1) at (4, 0.5) {$\ket{+}$};
    \node[wf] (w2) at (4, -0.5) {$\ket{-}$};
...
\begin{tikzpicture}[shorten >=1pt,auto, thick,
    ...
    \node[wf] (w1) at (4.75, 0.5) {$P^z_+\ket{\psi_s} \otimes \ket{+_\mathcal{X}}$};
    \node[wf] (w2) at (4.75, -0.5) {$P^z_-\ket{\psi_s} \otimes \ket{-_\mathcal{X}}$};
...
Using this result, we cannot write the final state in another basis:
\begin{align}
...
\begin{tikzpicture}[shorten >=1pt,auto, thick,
    ...
    \node(w0) at (-1,0) {$\ket{\psi_s} \otimes \ket{\varnothing_\mathcal{X}} \otimes \ket{\varnothing_a}$};
    \node[wf] (w1) at (5.25, 0.5) {$P^z_+\ket{\psi_s} \otimes \ket{+_\mathcal{X}} \otimes \ket{+_a}$};
    \node[wf] (w2) at (5.25, -0.5) {$P^z_-\ket{\psi_s} \otimes \ket{-_\mathcal{X}} \otimes \ket{-_a}$};
...
The dynamics for the second apparatus should do the following:
\begin{itemize}
...
\begin{tikzpicture}[shorten >=1pt,auto, thick,
    ...
    \node(w0) at (0.25,0) {$\ket{\psi_s} \otimes \ket{\varnothing_\mathcal{X}} \otimes \ket{\varnothing_{a_1}} \otimes \ket{\varnothing_{a_2}} $};
    ...
    % \node(bw1) at (-1.75, 1.75) {$P^z_+\ket{\psi}^s \otimes \ket{+}^{D_1}_z \otimes \ket{\varnothing}^{D_2}_\mathcal{X} $};
